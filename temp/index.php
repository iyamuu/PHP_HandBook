...
<body>
  ...
  <!-- アイキャッチ：開始 -->
  <div id="icatch">
    <img src="./temp/images/icatch.jpg" alt="">
  </div>
  <!-- アイキャッチ：終了 -->
  <!-- コンテンツ：開始 -->
  <div id="contents">
    ...
    <main id="main">
      <article>
        <section>
          <h2><img class="small" src="./temp/images/new.png"><br>更新情報</h2>
        ...
        <section>
          <h2><img class="small" src="./temp/images/about.png"><br>JikkyoPensionについて</h2>
          <h3>にこやか笑顔でお出迎え</h3>
          <p>
